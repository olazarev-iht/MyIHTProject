...
namespace SharedComponents.IhtModbus
{
    ...
    public class IhtModbusData
    {
        ...
        */
        ...
        public (string msg, string[] param) GetTorchTypedIdxInfo_forErrorLog(int iTorchTypeIdx, DescriptionData descData = DescriptionData.All)
        {
            //TODO: implement CultureResources
            //string torchType = CultureResources.GetString("_CultureUnknown");
            string torchType = "_CultureUnknown";
            ...
            var arrVal = descData == DescriptionData.All ? new string[] { desc, val }
                : descData == DescriptionData.OnlyDescritpion ? new string[] { desc } : new string[] { val };

            return ("FIT+3 {0}: {1}, {2}", arrVal);
        }
        ...
        public (string msg, string[] param) GetTorchControllerNotConnected()
        {
            //string desc = "_CultureFit3TorchControllerNotConnected";
            //string desc = CultureResources.GetString("_CultureFit3TorchControllerNotConnected");
            //string data = String.Format("FIT+3: {0}", desc);
            var msg = "FIT+3: {0}, {1}, {2}";
            var value = "_CultureFit3TorchControllerNotConnected";
            return (msg, new string[] { value });
        }
        ...
        public (string msg, string[] param) GetTorchTypeUndefined()
        {
            //string data = String.Format("FIT+3: {0}", desc);
            var msg = "FIT+3: {0}, {1}, {2}";
            var value = "_CultureFit3TorchTypeUndefined";
            return (msg, new string[] { value });
        }
        ...
        public (string msg, string[] param) GetTorchTypeCodeFault()
        {
            //string data = String.Format("FIT+3: {0}", desc);
            var msg = "FIT+3: {0}, {1}, {2}";
            var value = "_CultureFit3TorchTypeCodeFault";
            return (msg, new string[] { value });
        }
    }
