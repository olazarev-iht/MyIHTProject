...
namespace SharedComponents.IhtModbus
{
    public class IhtModbusParamConst
    {
        ...
        public static void SetConfigSimulationData(ref UInt16[] au16ConfigConst)
        {
            ...
            au16ConfigConst[(int)eIdxConfig.CutO2BlowOutPressureStep] = 100;
