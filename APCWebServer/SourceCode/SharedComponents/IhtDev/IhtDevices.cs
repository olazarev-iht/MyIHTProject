...
{
  public class IhtDevices : INotifyPropertyChanged, IDisposable
    {
        //                                                   V  00  . 02      . 09
        ...
        public static DataProvider<bool>? DataProviderIsControlsActive  = new();
        public static DataProvider<bool>? DataProviderIsProcessesActive = new();
        public static DataProvider<bool>? DataProviderIsClearanceControlsManual = new();
        public static DataProvider<int>?  DataProviderIsCuttingDataBaseIdChanged = new();
        ...
        private static void CreateIhtDevices()
        {
            ...
            {
                IhtDevice ihtDevice = kvp.Value;
                ihtDevice.DataProviderIsControlActive.DataChanged += IsControlActive;
                ihtDevice.DataProviderIsProcessActive.DataChanged += IsProcessActive;
                ihtDevice.DataProviderIsClearanceControlManual.DataChanged += IsClearanceControlManual;
            }
        }

        private static void IsControlActive(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsControlsActive?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }
        private static void IsProcessActive(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsProcessesActive?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }
        private static void IsClearanceControlManual(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsClearanceControlsManual?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }

        public static void IsCuttingDataBaseIdChanged(object sender, ProcessInfoEventArgs<int> e)
        {
            DataProviderIsCuttingDataBaseIdChanged?.OnDataChanged(new ProcessInfoEventArgs<int>(e.OldValue, e.NewValue));
        }
        ...
        /// <summary>
        /// Process-Parameter Dyn. aktualisieren
        /// </summary>
        public void UpdateProcessDynTechnology(IhtModbusData _ihtModbusData)
        {
            IhtDevice _ihtDevice = GetDevice(_ihtModbusData.SlaveId);
            if (_ihtDevice != null)
            {
              _ihtDevice.UpdateParamDynProcess(_ihtModbusData);
            }
        }

        /// <summary>
        /// Config-Parameter Dyn. aktualisieren
        /// </summary>
        public void UpdateConfigDynTechnology(IhtModbusData _ihtModbusData)
        {
            IhtDevice _ihtDevice = GetDevice(_ihtModbusData.SlaveId);
            if (_ihtDevice != null)
            {
              _ihtDevice.UpdateParamDynConfig(_ihtModbusData);
            }
        }

        /// <summary>
        /// Service-Parameter Dyn. aktualisieren
        /// </summary>
        public void UpdateServiceDynTechnology(IhtModbusData _ihtModbusData)
        {
            IhtDevice _ihtDevice = GetDevice(_ihtModbusData.SlaveId);
            if (_ihtDevice != null)
            {
              _ihtDevice.UpdateParamDynService(_ihtModbusData);
            }
        }
        ...
        */
        ...
        /// </summary>
        public void Copy_TechnologyConst(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetTechnologyConst();
            ihtModbusDataDes.SetTechnologyConstData(data);
            IhtDevice _ihtDevice = GetDevice(ihtModbusDataDes.SlaveId);
            if (_ihtDevice != null)
            {
                _ihtDevice.UpdateDataParamConstTechnology(ihtModbusDataDes);
            }
        }
        ...
        /// </summary>
        public void Copy_ProcessConst(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetProcessConst();
            ihtModbusDataDes.SetProcessConstData(data);
            IhtDevice _ihtDevice = GetDevice(ihtModbusDataDes.SlaveId);
            if (_ihtDevice != null)
            {
                _ihtDevice.UpdateDataParamConstProcess(ihtModbusDataDes);
            }
        }
        ...
        /// </summary>
        public void Copy_ConfigConst(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetConfigConst();
            ihtModbusDataDes.SetConfigConstData(data);
            IhtDevice _ihtDevice = GetDevice(ihtModbusDataDes.SlaveId);
            if (_ihtDevice != null)
            {
              _ihtDevice.UpdateDataParamConstConfig(ihtModbusDataDes);
            }
        }
        ...
        /// </summary>
        public void Copy_ServiceConst(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetServiceConst();
            ihtModbusDataDes.SetServiceConstData(data);
            IhtDevice _ihtDevice = GetDevice(ihtModbusDataDes.SlaveId);
            if (_ihtDevice != null)
            {
              _ihtDevice.UpdateDataParamConstService(ihtModbusDataDes);
            }
        }
        ...
        /// <summary>
        /// Technologie-Parameter Dyn. kopieren
        /// </summary>
        public void Copy_TechnologyDyn(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetDataTechnologyDyn();
            ihtModbusDataDes.SetTechnologyDynData(data);
            UpdateParamDynTechnology(ihtModbusDataDes);
        }
        ...
        public async Task<bool> Read_ProcessDynAsync(IhtModbusData ihtModbusData, bool updateDataParam)
        {
            ...
            if (blResult && updateDataParam)
            {
              UpdateParamDynProcess(ihtModbusData);
            }
            return blResult;
        }

        /// <summary>
        /// Process-Parameter Dyn. kopieren
        /// </summary>
        public void Copy_ProcessDyn(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetDataProcessDyn();
            ihtModbusDataDes.SetProcessDynData(data);
            UpdateParamDynProcess(ihtModbusDataDes);
        }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="_ihtModbusData"></param>
        public void UpdateParamDynProcess(IhtModbusData _ihtModbusData)
        {
            IhtDevice _ihtDevice = GetDevice(_ihtModbusData.SlaveId);
            if (_ihtDevice != null)
            {
        ...
        public async Task<bool> Read_ConfigDynAsync(IhtModbusData ihtModbusData, bool updateDataParam)
        {
            ...
            if (blResult && updateDataParam)
            {
              UpdateParamDynConfig(ihtModbusData);
            }
            return blResult;
        }

        /// <summary>
        /// Config-Parameter Dyn. kopieren
        /// </summary>
        public void Copy_ConfigDyn(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetDataConfigDyn();
            ihtModbusDataDes.SetConfigDynData(data);
            UpdateParamDynConfig(ihtModbusDataDes);
        }
        ...
        /// </summary>
        /// <param name="_ihtModbusData"></param>
        public void UpdateParamDynConfig(IhtModbusData ihtModbusData)
        {
                IhtDevice _ihtDevice = GetDevice(ihtModbusData.SlaveId);
                if (_ihtDevice != null)
                {
        ...
        public async Task<bool> Read_ServiceDynAsync(IhtModbusData ihtModbusData, bool updateDataParam)
        {
            ...
            if (blResult && updateDataParam)
            {
              UpdateParamDynService(ihtModbusData);
            }
            return blResult;
        }

        /// <summary>
        /// Service-Parameter Dyn. kopieren
        /// </summary>
        public void Copy_ServiceDyn(IhtModbusData ihtModbusDataSrc, IhtModbusData ihtModbusDataDes)
        {
            ushort[] data = ihtModbusDataSrc.GetDataServiceDyn();
            ihtModbusDataDes.SetServiceDynData(data);
            UpdateParamDynService(ihtModbusDataDes);
        }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="ihtModbusData"></param>
        public void UpdateParamDynService(IhtModbusData ihtModbusData)
        {
                IhtDevice _ihtDevice = GetDevice(ihtModbusData.SlaveId);
                if (_ihtDevice != null)
                {
