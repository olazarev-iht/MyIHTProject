...
{
    public class IhtDevice : INotifyPropertyChanged, IDisposable
    {
        ...
        public DataProcessInfo? dataProcessInfo 
        {
            get 
            {
                ...
                { 
                    ...
                    _dataProcessInfo.DataProviderIsControlActive.DataChanged += IsControlActive;
                    _dataProcessInfo.DataProviderIsProcessActive.DataChanged += IsProcessActive;
                    _dataProcessInfo.DataProviderIsClearanceControlManual.DataChanged += IsClearanceControlManual;
                }
        ...
        private void IsControlActive(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsControlActive?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }
        private void IsProcessActive(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsProcessActive?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }
        private void IsClearanceControlManual(object sender, ProcessInfoEventArgs<bool> e)
        {
            DataProviderIsClearanceControlManual?.OnDataChanged(new ProcessInfoEventArgs<bool>(e.OldValue, e.NewValue));
        }
