...
namespace SharedComponents.Models.APCHardware
{
    ...
    {
        [Description("Touchless Calibration")]
        ...
        StatusHeightControl,
        //------ new--------------
        [Description("Ignition Detection")]
        IgnitionDetectionEnable,
        [Description("Ignition PreFlow Multiplier")]
        IgnitionPreFlowMultiplier,
        [Description("Ignition Duration Time")]
        IgnitionOnDurationTime,
        [Description("Flashback Sensivitity")]
        FlashbackSensivitity,
        [Description("Linear Drive Up Speed Fast")]
        LinearDriveUpSpeedFast,
        [Description("Linear Drive Dn Speed Slow")]
        LinearDriveDnSpeedSlow,
        [Description("Linear Drive Dn Speed Fast")]
        LinearDriveDnSpeedFast,
        [Description("Linear Drive Up Speed Slow")]
        LinearDriveUpSpeedSlow,
        [Description("Linear Drive Ref Speed")]
        LinearDriveRefSpeed,
        [Description("Linear Drive Pos Speed")]
        LinearDrivePosSpeed,
        [Description("Linear Drive Manual Pos Speed")]
        LinearDriveManualPosSpeed,
        [Description("PID Error Threshold Delay")]
        PidErrorThresholdDelay,
        [Description("Tolerance InPosition")]
        ToleranceInPosition,
        [Description("Sensor Collision Output")]
        SensorCollisionOutputDisable,
        [Description("Sensor Collision Delay")]
        SensorCollisionDelay,
        [Description("Hose Length")]
        HoseLength,
        [Description("HeatO2 Post Flow Multiplier")]
        HeatO2PostFlowMultiplier,
        [Description("HeatO2 Post Flow Pressure")]
        HeatO2PostFlowPressure,

        [Description("Flame Offset Enable")]
    ...
    public class ParamGroupHelper
    {
        ...
        public static readonly Dictionary<SettingParamIds, (Enum? paramModbusEnum, string Format)> SettingParamsProperties = new()
        {
            ...
            { SettingParamIds.CurrCutO2BlowoutTime, (IhtModbusParamDyn.eIdxProcessInfo.CurrCutO2BlowoutTime, @"{ 'Mode':'ProgressCircular', 'Unit' : 's' }") },
            ...
            { SettingParamIds.IgnitionDetectionEnable, (IhtModbusParamDyn.eIdxProcess.IgnitionDetectionEnable, @"{ 'Mode':'Switch', 'Values': ['Disabled', 'Enabled'] }") },
            { SettingParamIds.IgnitionPreFlowMultiplier, (IhtModbusParamDyn.eIdxService.IgnitionPreFlowMultiplier, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.IgnitionOnDurationTime, (IhtModbusParamDyn.eIdxService.IgnitionOnDurationTime, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.FlashbackSensivitity, (IhtModbusParamDyn.eIdxProcess.FlashbackSensivitity, @"{ 'Mode':'Select', 'Values': ['Low','Medium','High'] }") },
            { SettingParamIds.LinearDriveUpSpeedFast, (IhtModbusParamDyn.eIdxConfig.LinearDriveUpSpeedFast, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDriveDnSpeedSlow, (IhtModbusParamDyn.eIdxConfig.LinearDriveDnSpeedSlow, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDriveDnSpeedFast, (IhtModbusParamDyn.eIdxConfig.LinearDriveDnSpeedFast, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDriveUpSpeedSlow, (IhtModbusParamDyn.eIdxConfig.LinearDriveUpSpeedSlow, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDriveRefSpeed, (IhtModbusParamDyn.eIdxConfig.LinearDriveRefSpeed, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDrivePosSpeed, (IhtModbusParamDyn.eIdxConfig.LinearDrivePosSpeed, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.LinearDriveManualPosSpeed, (IhtModbusParamDyn.eIdxProcess.LinearDriveManualPosSpeed, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.PidErrorThresholdDelay, (IhtModbusParamDyn.eIdxService.PidErrorThresholdDelay, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.ToleranceInPosition, (IhtModbusParamDyn.eIdxService.ToleranceInPosition, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.SensorCollisionOutputDisable, (IhtModbusParamDyn.eIdxService.SensorCollisionOutputDisable, @"{ 'Mode':'Switch', 'Values': ['Disabled', 'Enabled'] }") },
            { SettingParamIds.SensorCollisionDelay, (IhtModbusParamDyn.eIdxConfig.SensorCollisionDelay, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.HoseLength, (IhtModbusParamDyn.eIdxConfig.HoseLength, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.HeatO2PostFlowMultiplier, (IhtModbusParamDyn.eIdxService.HeatO2PostFlowMultiplier, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.HeatO2PostFlowPressure, (IhtModbusParamDyn.eIdxService.HeatO2PostFlowPressure, @"{ 'Mode':'Slider' }") },
            { SettingParamIds.CapSetpointFlameOffs, (IhtModbusParamDyn.eIdxConfig.CapSetpointFlameOffs, @"{ 'Mode':'Switch', 'Values': ['Disabled', 'Enabled'] }") },
        };
