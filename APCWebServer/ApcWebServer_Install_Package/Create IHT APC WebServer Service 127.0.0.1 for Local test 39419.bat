...
sc.exe create "IHT APC WebServer Service" binPath= "%user_mashine_publish_folder%\IhtApcWebServer.exe --tcpaddr 127.0.0.1 --tcpport 39419 --m messe --client default"
