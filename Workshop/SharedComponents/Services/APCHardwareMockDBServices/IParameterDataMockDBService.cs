...
namespace SharedComponents.Services.APCHardwareMockDBServices
{
	public interface IParameterDataMockDBService
	{
		...
		public Task<ParameterDataModel?> GetEntryByAPCDeviceAndParamIdAsync(int apcDeviceNum, ParamGroup paramGroup, int paramId, CancellationToken cancellationToken);
