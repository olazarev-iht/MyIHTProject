...
namespace SharedComponents.Services.APCHardwareMockDBServices
{
    public interface IAPCSimulationDataMockDBService
    {
        ...
        public Task<IEnumerable<APCSimulationDataModel>> GetApcSimulationDataSetByAddressAndNumber(ushort startAddress, ushort numParams, CancellationToken cancellationToken);
