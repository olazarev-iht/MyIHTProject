...
{
	public class LiveParamsMoqDBService : ILiveParamsMoqDBService
	{
		private readonly IDbContextFactory<APCHardwareMoqDBContext> _dbContextFactory;

		private readonly DbModelMapper _mapper;

		public LiveParamsMoqDBService(IDbContextFactory<APCHardwareMoqDBContext> dbContextFactory, DbModelMapper mapper)
		{
