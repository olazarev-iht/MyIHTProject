...
namespace BlazorServerHost.Data
{
	public class APCHardwareMoqDBContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			var HeatO2Cut_Dyn = new DynParams { Id = HeatO2Cut_Dyn_Id, ParamId = ParamIds.CutO2Cut, ConstParamsId = HeatO2Cut_Const_Id, Value = 2000 };
			...
			var ParameterData_HeatO2Ignition = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_HeatO2Ignition", APCDeviceId = APCDeviceId1, DynParamsId = HeatO2Ignition_Dyn_Id };
			var ParameterData_HeatO2PreHeat = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_HeatO2PreHeat", APCDeviceId = APCDeviceId1, DynParamsId = HeatO2PreHeat_Dyn_Id };
			var ParameterData_HeatO2Pierce = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_HeatO2Pierce", APCDeviceId = APCDeviceId1, DynParamsId = HeatO2Pierce_Dyn_Id };
			var ParameterData_HeatO2Cut = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_HeatO2Cut", APCDeviceId = APCDeviceId1, DynParamsId = HeatO2Cut_Dyn_Id };
			var ParameterData_FuelGasIgnition = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_FuelGasIgnition", APCDeviceId = APCDeviceId1, DynParamsId = FuelGasIgnition_Dyn_Id };
			var ParameterData_FuelGasPreHeat = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_FuelGasPreHeat", APCDeviceId = APCDeviceId1, DynParamsId = FuelGasPreHeat_Dyn_Id };
			var ParameterData_FuelGasPierce = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_FuelGasPierce", APCDeviceId = APCDeviceId1, DynParamsId = FuelGasPierce_Dyn_Id };
			var ParameterData_FuelGasCut = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_FuelGasCut", APCDeviceId = APCDeviceId1, DynParamsId = FuelGasCut_Dyn_Id };
			var ParameterData_CutO2Pierce = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_CutO2Pierce", APCDeviceId = APCDeviceId1, DynParamsId = CutO2Pierce_Dyn_Id };
			var ParameterData_CutO2Cut = new ParameterData { Id = Guid.NewGuid(), ParamName = "Device1_CutO2Cut", APCDeviceId = APCDeviceId1, DynParamsId = CutO2Cut_Dyn_Id };
		...
		public void CreateParameterDataForDevice(ModelBuilder modelBuilder)
        {
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//ConstParams
			//
